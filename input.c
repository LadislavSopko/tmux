...
/* MSVC doesn't support forward declaration of static arrays with unknown size.
 * Use non-static (extern linkage) tables on Windows. */
#ifdef _WIN32
#define INPUT_TABLE_DEF const struct input_transition
#else
#define INPUT_TABLE_DEF static const struct input_transition
#endif
...
INPUT_TABLE_DEF input_state_ground_table[];
INPUT_TABLE_DEF input_state_esc_enter_table[];
INPUT_TABLE_DEF input_state_esc_intermediate_table[];
INPUT_TABLE_DEF input_state_csi_enter_table[];
INPUT_TABLE_DEF input_state_csi_parameter_table[];
INPUT_TABLE_DEF input_state_csi_intermediate_table[];
INPUT_TABLE_DEF input_state_csi_ignore_table[];
INPUT_TABLE_DEF input_state_dcs_enter_table[];
INPUT_TABLE_DEF input_state_dcs_parameter_table[];
INPUT_TABLE_DEF input_state_dcs_intermediate_table[];
INPUT_TABLE_DEF input_state_dcs_handler_table[];
INPUT_TABLE_DEF input_state_dcs_escape_table[];
INPUT_TABLE_DEF input_state_dcs_ignore_table[];
INPUT_TABLE_DEF input_state_osc_string_table[];
INPUT_TABLE_DEF input_state_apc_string_table[];
INPUT_TABLE_DEF input_state_rename_string_table[];
INPUT_TABLE_DEF input_state_consume_st_table[];
